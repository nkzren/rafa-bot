...
class RafaBot extends Client {
  constructor(options) {
    ...
    // this.db = new DataStore("database.db")
  }
 ...
 * Event modules constructor MUST have a 'name' property with the exact name of the event (CASE SENSITIVE)
 */
